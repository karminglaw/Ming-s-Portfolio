...
const Experience = () => {
    return (
      <div className="border-b border-neutral-100 pb-4">
        ...
        className="my-20 text-center text-4xl"><span className="bg-gradient-to-r from-blue-300 via-blue-200 to-sky-400 bg-clip-text text-4xl tracking-tight text-transparent">
                    Experience
                </span></motion.h2>
        <div>
          {EXPERIENCES.map((experience, index) => (
            <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
              ...
              className="w-full lg:w-1/4">
                <p className="mb-2 text-sm text-zinc-600">{experience.year}</p>
              </motion.div>
              <motion.div 
                whileInView={{opacity:1, x: 0}}
                initial={{opacity:0, x:70}}
